...
class Service extends CI_Controller
    ...
    public function index()
        {
        $data['title'] = 'Сервис';
        $data['meta'] = $this->req->get_meta(1, 'service');
        $item_data_text = $this->req->get_item_data_text(1, 'service');
        $item_data_img = $this->req->get_item_data_img(1, 'service');
        $item_data_list = $this->req->get_item_data_list(1, 'service');
